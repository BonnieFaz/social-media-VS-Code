import PostCommentBlock from '../PostLiked/PostCommentBlock';
import PostUserElem from '../PostLiked/PostUserElem'


const PostReport = () => {
    return (
        <div className="Post Repost _liked _marked">
            <PostUserElem img="./img/users/mark-krahmalev.jpeg" main__text='Марк Крахмалев' secondary__text='20 марта 23:31'/>
       
        <div className="Repost__wrapper">
        <PostUserElem img="./img/users/aleksandr-maykov.jpeg" main__text='Александр Майков' secondary__text='Сегодня 9:37'/>
        ...
        <PostCommentBlock userImg="./img/users/aleksandr-maykov.jpeg"
        ownerComment="Карина Савина" textComment='Это текст комментария...' reply="Ответить" date="25 марта"/>
